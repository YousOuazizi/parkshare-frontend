...
export const PARKING_ROUTES: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("./components/parking-list/parking-list.component").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("./components/parking-form/parking-form.component").then(
  ...
  },
  {
    path: ":id",
    loadComponent: () =>
      import("./components/parking-detail/parking-detail.component").then(
