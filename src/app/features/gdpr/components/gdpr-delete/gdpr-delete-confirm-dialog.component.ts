    ...
    <div class="confirm-dialog">
      ...
      <mat-dialog-content>
        <div class="warning-message">
          ...
          <p>
            You are about to permanently delete your ParkShare account and all
          ...
          <div class="consequences-list">
            ...
            <ul>
              <li>
                <mat-icon>delete_forever</mat-icon> All your personal data will
                be permanently deleted
              </li>
              <li>
                <mat-icon>event_busy</mat-icon> You will lose access to all
                bookings and parking spots
              </li>
              <li>
                <mat-icon>block</mat-icon> Your account will be deactivated
                immediately
              </li>
              <li>
                <mat-icon>no_accounts</mat-icon> You will not be able to recover
                this account
              </li>
            </ul>
          </div>
