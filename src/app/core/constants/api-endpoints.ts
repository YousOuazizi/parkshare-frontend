export const API_ENDPOINTS = {
  ...
  VERIFICATION: {
    ...
    IDENTITY_APPROVE: (userId: string) =>
      `/verification/identity/approve/${userId}`,
    ADVANCED_APPROVE: (userId: string) =>
      `/verification/advanced/approve/${userId}`,
  },
  ...
  PRICE_RULES: {
    ...
    CALCULATE: (parkingId: string) =>
      `/price-rules/calculate-price/${parkingId}`,
  },
  ...
  BOOKINGS: {
    ...
    STATS_PARKING: (parkingId: string) =>
      `/bookings/stats/parking/${parkingId}`,
  },
  ...
  SUBSCRIPTION_PLANS: {
    ...
    BY_RECURRENCE: (recurrence: string) =>
      `/subscription-plans/recurrence/${recurrence}`,
  },
  ...
  SUBSCRIPTIONS: {
    ...
    CHECK_ACCESS: (parkingId: string) =>
      `/subscriptions/check-access/${parkingId}`,
  },
  ...
  GDPR: {
    ...
    DATA_EXPORT_DOWNLOAD: (requestId: string) =>
      `/gdpr/data-export/${requestId}/download`,
    ...
    ADMIN: {
      ...
      APPROVE_DELETION: (id: string) =>
        `/gdpr/admin/deletion-requests/${id}/approve`,
      REJECT_DELETION: (id: string) =>
        `/gdpr/admin/deletion-requests/${id}/reject`,
      EXECUTE_DELETION: (id: string) =>
        `/gdpr/admin/deletion-requests/${id}/execute`,
    },
  },
